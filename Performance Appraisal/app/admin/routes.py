...
from shared_models.models import Authentication,AdminObjective,Employee,Review,ObjectiveBatch,AdminReview,Administrator,Objective,EmployeeEmail,TeamLeader,Messages,Review,AuthReviewed,ReviewOpenObjective
...
admin_bp = Blueprint("PAadmin",__name__,url_prefix="/performance_appraisal/admin")
