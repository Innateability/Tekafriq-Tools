...
from shared_models.models import Employee,Authentication,TeamLeader,Department,Administrator,EmployeeEmail
...
base_bp = Blueprint("PAbase",__name__,url_prefix="/performance_appraisal")
